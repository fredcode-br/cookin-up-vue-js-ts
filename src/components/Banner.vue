<template>
    <header class="banner">
      <div class="apresentacao">
        <img 
          src="../assets/images/icones/logo.svg" 
          alt="Logo do Cookin' Up" 
          class="logo"
        />
        <p class="cabecalho-lg frase-cabecalho">
          Um banquete de ideias para <span class="texto-verde">despertar o chef que há em vôce!</span>
        </p>
        <p class="subtitulo-lg">
          Explore novas receitas todos os dias com os ingredintes que estão ao seu alcance!
        </p>
      </div>
